...
----
$ helm install microprofile-config-app -f examples/microprofile-config/microprofile-config.yaml ./charts/wildfly
----
...
[source,options="nowrap"]
----
$ helm install microprofile-config-app -f examples/microprofile-config/microprofile-config-s2i.yaml ./charts/wildfly
----
